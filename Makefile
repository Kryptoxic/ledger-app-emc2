...
APPNAME ="Resistance"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),einsteinium)
# Einsteinium
DEFINES   += COIN_P2PKH_VERSION=33 COIN_P2SH_VERSION=5 COIN_FAMILY=1 COIN_COINID=\"Einsteinium\" COIN_COINID_HEADER=\"EINSTEINIUM\" COIN_COLOR_HDR=0x3790CA COIN_COLOR_DB=0x9BC8E5 COIN_COINID_NAME=\"Einsteinium\" COIN_COINID_SHORT=\"EMC2\" COIN_KIND=COIN_KIND_EINSTEINIUM
APPNAME ="Einsteinium"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
